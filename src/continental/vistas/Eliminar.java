...
public class Eliminar extends javax.swing.JInternalFrame {
     ...
     * @param al
     */
    public Eliminar(Huesped h) {
        this.h = h;
        this.clase = 1;
        initComponents();
        jLTitulo.setText("¿Desea eliminar este huesped?");
    }
     ...
     * @param mat
     */
    public Eliminar(Habitacion hab) {
        this.hab = hab;
        this.clase = 2;
        initComponents();
        ...
        switch (clase) {
            ...
            case 2:
                ...
                if (registro == 1) {
                    ...
                    JOptionPane.showMessageDialog(this, "No se pudo borrar a la habitacion");
                }
                dispose();
                break;
        }
